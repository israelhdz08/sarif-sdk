...
{
    public class BuildXLConverter : ToolFileConverterBase
    {
        public BuildXLConverter() : this(false) { }

        public BuildXLConverter(bool verbose)
        {
            _verbose = verbose;
        }
        ...
        public override string ToolName => ToolFormat.BuildXL;
